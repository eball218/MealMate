...
export default function ImageGenerator() {
  ...
  return (
    <div className="h-full bg-white rounded-3xl shadow-sm border border-stone-100 flex flex-col p-6 overflow-y-auto w-full max-w-7xl mx-auto">
      <div className="mb-6">
      ...
      <div className="flex flex-col md:flex-row gap-8 h-full">
        <div className="w-full md:w-1/3 space-y-4">
          <div>
            ...
            <textarea
              className="w-full p-4 rounded-2xl border border-stone-200 focus:ring-2 focus:ring-lime-400 outline-none resize-none h-48 text-sm font-medium"
        ...
        {/* Result Area */}
        <div className="flex-1 min-h-[300px] md:min-h-0 bg-stone-50 rounded-2xl border-2 border-dashed border-stone-200 relative overflow-hidden group">
          {loading && (
          ...
          {generatedImage ? (
            ...
            <div className="text-center text-stone-400 p-8 h-full flex flex-col items-center justify-center">
              {!loading && (
                <>
